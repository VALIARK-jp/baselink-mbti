      ...
      <div className="min-h-screen bg-gradient-to-br from-baselink-light via-white to-slate-50 py-8 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-6">
            <button
              onClick={() => router.push("/")}
              className="flex items-center gap-1.5 bg-white/80 backdrop-blur-sm hover:bg-white px-3 py-1.5 rounded-full shadow-md hover:shadow-lg transform transition-all hover:scale-105 active:scale-100 text-slate-700 hover:text-slate-900 mb-4"
            >
              <svg
                className="w-4 h-4"
                fill="none"
