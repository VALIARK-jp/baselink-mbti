...
export const newResultMapping: NewResultMapping = {
  ...
  LNRB: {
    ...
    advice: "Baselink AIがあなたの論理的思考と安定感を言語化し、さらなる成長への道筋を示します。",
  },
  LNRA: {
    title: "即応司令",
    player: "例: 柳田悠岐",
    ...
    advice: "Baselink AIがあなたの即応力と判断力を分析し、次のステージへの指針を提供します。",
  },
  LPRB: {
    title: "戦略設計者",
    player: "例: 菊池涼介",
    ...
    advice: "Baselink AIがあなたの戦略的思考を可視化し、勝利への青写真を描きます。",
  },
  LPRA: {
    title: "戦況調整官",
    player: "例: 山田哲人",
    ...
    advice: "Baselink AIがあなたの俯瞰力と調整力を言語化し、リーダーシップを強化します。",
  },
  ...
  LNIB: {
    ...
    advice: "Baselink AIがあなたの情熱と突破力を数値化し、最高のパフォーマンスを引き出します。",
  },
  LNIA: {
    title: "ムードチェンジャー",
    player: "例: 村上宗隆",
    ...
    advice: "Baselink AIがあなたの感性と影響力を分析し、さらなる高みへ導きます。",
  },
  LPIB: {
    title: "信念型主将",
    player: "例: 大谷翔平",
    ...
    advice: "Baselink AIがあなたの信念と行動力を言語化し、夢への道を照らします。",
  },
  LPIA: {
    title: "ビジョン牽引者",
    player: "例: 吉田正尚",
    ...
    advice: "Baselink AIがあなたのビジョンと柔軟性を可視化し、チーム力を最大化します。",
  },
  ...
  FNRB: {
    ...
    advice: "Baselink AIがあなたの安定感と継続力を分析し、プロレベルへの道筋を示します。",
  },
  FNRA: {
    title: "調整職人",
    player: "例: 近藤健介",
    ...
    advice: "Baselink AIがあなたの微調整力と適応力を言語化し、成長を加速させます。",
  },
  FPRB: {
    title: "分析屋",
    player: "例: 鈴木誠也",
    ...
    advice: "Baselink AIがあなたの分析力と再現性を数値化し、勝利への方程式を導きます。",
  },
  FPRA: {
    title: "改善役",
    player: "例: 源田壮亮",
    ...
    advice: "Baselink AIがあなたの改善力と成長性を可視化し、次のレベルへ導きます。",
  },
  ...
  FNIB: {
    ...
    advice: "Baselink AIがあなたの独自性と感性を言語化し、オンリーワンの才能を開花させます。",
  },
  FNIA: {
    title: "自由人",
    player: "例: 中野拓夢",
    ...
    advice: "Baselink AIがあなたの自由な発想と適応力を分析し、才能を最大化します。",
  },
  FPIB: {
    title: "理想追求者",
    player: "例: 牧秀悟",
    ...
    advice: "Baselink AIがあなたの理想と個性を可視化し、唯一無二のスタイルを確立します。",
  },
  FPIA: {
    title: "クリエイター",
    player: "例: 森下暢仁",
    ...
    advice: "Baselink AIがあなたの創造性と探究心を言語化し、無限の可能性を引き出します。",
  },
};
